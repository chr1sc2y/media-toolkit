...
COMMANDS = (
    ...
    Command(
        canonical="subject-plan",
        aliases=(),
        script_name="subject_plan.py",
        help="Prepare individual HIF previews and a per-image portrait subject plan.",
        module_name="media_toolkit.commands.subject_plan",
        default_cwd=True,
        options_with_values=("--ratings", "--output", "--preview-dir"),
        side_effects=("write-review-previews", "write-plan"),
    ),
    Command(
        canonical="subject-apply",
        aliases=(),
        script_name="subject_apply.py",
        help="Apply a reviewed per-image Lightroom Select Subject plan.",
        module_name="media_toolkit.commands.subject_apply",
        default_cwd=True,
        options_with_values=("--plan", "--ratings"),
        side_effects=("write-xmp-mask",),
        supports_dry_run=True,
    ),
    Command(
        canonical="styles",
